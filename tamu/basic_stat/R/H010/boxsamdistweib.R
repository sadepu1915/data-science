...
boxplot(m10,m25,m100,xlab="Sample Size",lab=c(10,10,7),
                  ylab="Sample Mean",
          main="Boxplots of 10000 Sample Means from Weibull(.62,.61)",
...
boxplot(q10,q25,q100,xlab="Sample Size",lab=c(10,10,7),
                  ylab="Sample Median",
          main="Boxplots of 10000 Sample Medians from Weibull(.62,.61)",
                  names=c("10","25","100"),cex=.75)   
...
boxplot(s10,s25,s100,xlab="Sample Size",lab=c(10,10,7),
          ...
          main="Boxplots of 10000 of Sample Std Dev from Weibull(.62,.61)",
                  names=c("10","25","100"),cex=.75)      

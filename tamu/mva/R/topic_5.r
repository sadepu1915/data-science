...
T2_b <- rep(NA, B)
for(b in 1:B) {
  ## Generate bootstrap sample under H_0. by row ....thats picking  sampple by row
...
p_value_boot <- mean(T2_b >= drop(T2)) # comparing/avging across 2500 tb2 vs t2 and making propotion 
